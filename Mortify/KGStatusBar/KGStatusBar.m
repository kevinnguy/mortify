...
+ (void)showStatusForever:(NSString *)status {
    float black = 49.0f;
    [[KGStatusBar sharedView] showWithStatus:status barColor:[UIColor colorWithRed:black/255.0f green:black/255.0f blue:black/255.0f alpha:1.0f] textColor:[UIColor whiteColor]];
}
